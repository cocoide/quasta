    ...
    return (
        <div className="flex flex-col w-full">
            <form onSubmit={handleSubmit(onSubmit)}
                className="flex flex-col items-center w-full bg-neutral">
                <div className="flex flex-row items-center p-2 w-full">
                    ...
                    <input {...register("comment", { minLength: 3, maxLength: 50 })}
                        className="bg-white w-full h-9 rounded-full mx-3 py-1 px-2 shadow-inner
            ...
            {comments.map((comment, i) => {
                return (
                    <div key={i} className="flex  flex-col  pt-2 pl-3">
                        ...
                        <h3 className="text-gray-500 text-[13px] p-2">{comment.comment}</h3>
                    </div>
                )
            })}
